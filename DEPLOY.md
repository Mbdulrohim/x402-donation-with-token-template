...
- `TOKEN_NAME`: Name of your token (e.g., "My Token")
- `TOKEN_SYMBOL`: Token symbol (e.g., "MTK")
- `TOKEN_IMAGE_URL`: URL to token logo image
- `TOKEN_DESCRIPTION`: Short description of your token
- `TOTAL_SUPPLY`: Total token supply (e.g., 1000000000)
- `MINTABLE_SUPPLY`: Amount available for distribution (e.g., 1000000)
- `DONATION_TARGET`: Target USD amount to raise (e.g., 1000)
- `NEXT_PUBLIC_SOLANA_NETWORK`: `solana-devnet` or `solana`
- `NEXT_PUBLIC_SOLANA_RPC_URL`: Solana RPC endpoint
- `NEXT_PUBLIC_TOKEN_MINT`: Same as TOKEN_MINT
- `NEXT_PUBLIC_TOKEN_NAME`: Same as TOKEN_NAME
- `NEXT_PUBLIC_TOKEN_SYMBOL`: Same as TOKEN_SYMBOL
- `NEXT_PUBLIC_TOKEN_IMAGE_URL`: Same as TOKEN_IMAGE_URL
- `NEXT_PUBLIC_TOKEN_DESCRIPTION`: Same as TOKEN_DESCRIPTION
- `NEXT_PUBLIC_MINTABLE_SUPPLY`: Same as MINTABLE_SUPPLY
- `NEXT_PUBLIC_DONATION_TARGET`: Same as DONATION_TARGET
